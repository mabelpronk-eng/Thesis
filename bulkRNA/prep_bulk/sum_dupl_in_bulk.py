...
(e.g., using 'dupl_bulk_in_signature.py'), as summing marker genes may affect downstream analyses.
...
# First use script: dupl_bulk_in_signature.py to verify whether duplicates are present 
